...
export function HeroSection() {
  ...
  return (
    <section className="relative w-full min-h-[600px] md:min-h-[700px] lg:min-h-[90vh] flex items-center px-5 md:px-10 lg:px-[80px] overflow-hidden">
      {/* Video Background */}
      <div className="absolute inset-0 z-0">
        ...
        >
          {/* Placeholder: Replace with your actual video URL */}
